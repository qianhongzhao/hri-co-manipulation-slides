...
\pinkcomment{if only option B can be used in the NPACE, form this option as Option A and make the original Option A as Option B }
\end{alertblock}
\end{frame}
...
\end{block}
\pinkcomment{here needs more explanations， what is the meaning for each nnotation? Noboday can follow. Too much undefined notations here. what is attractor model? consider use one more page to explain.}
\column{0.44\textwidth}
\begin{exampleblock}{Why it is attractive}
