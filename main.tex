...
\begin{columns}[T,onlytextwidth]
  ...
  How can the robot model the human well enough to support real-time planning and control?
  \end{alertblock}
  \vspace{0.25cm}
...
\begin{itemize}
  \item \key{Multimodal}: multiple strategies may be reasonable in the same situation.
...
\begin{itemize}
  \item Learns multimodal collaborative action sequences
